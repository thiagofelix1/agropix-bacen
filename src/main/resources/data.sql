...
CREATE TABLE IF NOT EXISTS url_noticacao(id uuid PRIMARY KEY, url character varying(255), nome_banco character varying(255));
INSERT INTO url_noticacao (id, url, nome_banco) VALUES ('96ca732d-db8f-4af5-9acd-6fa610f73daf', 'http://itau:5000/api/transferencia-pix/notificacao', 'ITAU') ON CONFLICT DO NOTHING;
INSERT INTO url_noticacao (id, url, nome_banco) VALUES ('9b6bdab4-fe4f-4531-adca-64b5b96ad052', 'http://ada:5000/api/transferencia-pix/notificacao', 'ADA') ON CONFLICT DO NOTHING;
